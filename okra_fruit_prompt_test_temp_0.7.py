#!/usr/bin/env python3
"""
New Models Okra Fruit Prompt Variation Test (Temperature 0.7)
Tests all NEW_MODELS with specific prompt variations using the okra fruit question.
...
class NewModelsOkraFruitPromptTester:
    def __init__(self):
    ...
    async def test_all_prompt_variations(self):
        ...
        logger.info(f"Starting Okra Fruit test with {TRIALS_PER_PROMPT} trials per prompt variation")
    ...
    def save_results(self) -> Path:
        ...
        try:
            output_dir = Path("okra_fruit_prompt_test_results_temp_0.7")
    ...
    def create_graph(self, output_dir: Path):
        ...
        try:
            ...
            plt.title(f'Is okra a fruit? (Temperature {TEMPERATURE})\n'
            ...
            graph_path = output_dir / "okra_fruit_prompt_variations_horizontal.png"
    ...
    def generate_report(self, output_dir: Path):
        ...
        try:
            ...
            report_content = f"""NEW MODELS OKRA FRUIT PROMPT VARIATION TEST REPORT (TEMPERATURE {TEMPERATURE})
...
async def main():
    """Main function."""
    tester = NewModelsOkraFruitPromptTester()
    
    print(f"Starting New Models Okra Fruit Prompt Variation Test (Temperature {TEMPERATURE})")
