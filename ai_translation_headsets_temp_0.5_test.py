#!/usr/bin/env python3
"""
Historical Models AI Translation Headsets Test (Temperature 0.5)
Tests all historical models with the AI translation headsets question, 100 trials per model at temperature 0.5.
"""
...
# Test configuration
TEST_QUESTION = 'Does "compensation of interpreters" include the cost of AI-equipped translation headsets?'
...
class HistoricalModelsAITranslationHeadsetsTester:
    def __init__(self):
    ...
    async def test_all_historical_models(self):
        ...
        logger.info(f"Starting AI Translation Headsets test with {TRIALS_PER_MODEL} trials per model")
        
        total_trials = sum(len(models) for models in HISTORICAL_MODELS.values()) * TRIALS_PER_MODEL
        
        with tqdm(total=total_trials, desc="Testing models") as pbar:
    ...
    def save_results(self) -> Path:
        ...
        try:
            ...
            output_dir = Path("ai_translation_headsets_temp_0.5_results")
    ...
    def create_graph(self, output_dir: Path):
        ...
        try:
            ...
            # Customize the plot
            plt.title(f'Does "compensation of interpreters" include the cost of AI-equipped translation headsets? (Temperature {TEMPERATURE})\nNumber of "Yes" Responses per Model', 
            ...
            # Save the plot
            graph_path = output_dir / f"historical_models_ai_translation_headsets_graph_temp_{TEMPERATURE}.png"
    ...
    def generate_report(self, output_dir: Path):
        ...
        try:
            ...
            # Generate report
            report_content = f"""HISTORICAL MODELS AI TRANSLATION HEADSETS TEST REPORT (TEMPERATURE {TEMPERATURE})
...
async def main():
    """Main function."""
    tester = HistoricalModelsAITranslationHeadsetsTester()
    
    print(f"Starting Historical Models AI Translation Headsets Test (Temperature {TEMPERATURE})")
