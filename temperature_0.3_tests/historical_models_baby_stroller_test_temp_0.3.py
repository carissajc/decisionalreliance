#!/usr/bin/env python3
"""
Historical Models Baby Stroller Test (Temperature 0.3)
Tests all historical models with the baby stroller question, 100 trials per model at temperature 0.3.
"""
...
# Temperature (0.3 for this version)
TEMPERATURE = 0.3
...
class HistoricalModelsBabyStrollerTester:
    ...
    def save_results(self):
        ...
        output_dir = Path("temperature_0.3_tests/historical_models_baby_stroller_results_temp_0.3")
    ...
    def create_graph(self, summary_df: pd.DataFrame):
        ...
        try:
            ...
            # Save the plot
            output_dir = Path("temperature_0.3_tests/historical_models_baby_stroller_results_temp_0.3")
            plot_file = output_dir / "historical_models_baby_stroller_graph_temp_0.3.png"
    ...
    def generate_report(self, summary_df: pd.DataFrame):
        ...
        try:
            ...
            with open(report_file, 'w') as f:
                f.write("HISTORICAL MODELS BABY STROLLER TEST REPORT (TEMPERATURE 0.3)\n")
                f.write("=" * 70 + "\n\n")
...
async def main():
    ...
    logger.info("Starting historical models baby stroller test (Temperature 0.3)...")
    ...
    try:
        ...
        if summary is not None:
            ...
            logger.info(f"Results saved in: temperature_0.3_tests/historical_models_baby_stroller_results_temp_0.3/")
            
            # Print summary to console
            print("\n" + "="*80)
            print("HISTORICAL MODELS BABY STROLLER TEST COMPLETED (TEMPERATURE 0.3)")
            print("="*80)
            ...
            print(f"\nResults saved in: temperature_0.3_tests/historical_models_baby_stroller_results_temp_0.3/")
