#!/usr/bin/env python3
"""
New Models Prompt Variation Test (Temperature 0.7)
Tests all NEW_MODELS with specific prompt variations, 100 trials per prompt at temperature 0.7.
"""
...
class NewModelsPromptTester:
    ...
    def save_results(self):
        ...
        output_dir = Path("new_models_prompt_test_results_temp_0.7")
    ...
    def create_graph(self, output_dir: Path):
        ...
        # Customize the plot
        plt.title(f'New Models Prompt Variations Test (Temperature {TEMPERATURE})\nAverage "Yes" Percentage by Prompt', 
        ...
        # Save the plot
        graph_path = output_dir / f"new_models_prompt_variations_horizontal_temp_{TEMPERATURE}.png"
    ...
    def generate_report(self, output_dir: Path):
        ...
        # Generate report
        report_content = f"""NEW MODELS PROMPT VARIATIONS TEST REPORT (TEMPERATURE {TEMPERATURE})
...
async def main():
    """Main function."""
    tester = NewModelsPromptTester()
    
    print(f"Starting New Models Prompt Variations Test (Temperature {TEMPERATURE})")
