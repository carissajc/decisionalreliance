#!/usr/bin/env python3
"""
Historical Models Meal Reimbursement Test (Temperature 0.5)
Tests all historical models with the meal reimbursement question, 100 trials per model at temperature 0.5.
"""
...
# Test configuration
TEST_QUESTION = 'Does "meal reimbursement" fall within the definition of "money remuneration"?'
...
class HistoricalModelsMealReimbursementTester:
    def __init__(self):
    ...
    async def test_all_historical_models(self):
        ...
        logger.info(f"Starting Meal Reimbursement test with {TRIALS_PER_MODEL} trials per model")
    ...
    def save_results(self) -> Path:
        ...
        try:
            ...
            output_dir = Path("meal_reimbursement_temp_0.5_results")
    ...
    def create_graph(self, output_dir: Path):
        ...
        try:
            ...
            # Customize the plot
            plt.title(f'Does "meal reimbursement" fall within the definition of "money remuneration"? (Temperature {TEMPERATURE})\nNumber of "Yes" Responses per Model', 
            ...
            # Save the plot
            graph_path = output_dir / f"historical_models_meal_reimbursement_graph_temp_{TEMPERATURE}.png"
    ...
    def generate_report(self, output_dir: Path):
        ...
        try:
            ...
            # Generate report
            report_content = f"""HISTORICAL MODELS MEAL REIMBURSEMENT TEST REPORT (TEMPERATURE {TEMPERATURE})
...
async def main():
    """Main function."""
    tester = HistoricalModelsMealReimbursementTester()
    
    print(f"Starting Historical Models Meal Reimbursement Test (Temperature {TEMPERATURE})")
