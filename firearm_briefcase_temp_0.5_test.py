#!/usr/bin/env python3
"""
Historical Models Firearm Briefcase Test (Temperature 0.5)
Tests all historical models with the firearm briefcase question, 100 trials per model at temperature 0.5.
"""
...
class HistoricalModelsFirearmBriefcaseTester:
    ...
    def save_results(self):
        ...
        output_dir = Path("firearm_briefcase_temp_0.5_results")
